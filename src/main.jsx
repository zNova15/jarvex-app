...
import {
  ...
  useCompanies, useConsorcios, useConsorcioSocios, useTrabajos, useTrabajoCotizaciones, useAccountingMovements, useRevisionDescartes, useIntercompanyTransactions, useTrazabilidadCadenas,
  useConsultasPuente, useInsumoCorrelaciones, useInsumoMapeos, useInsumoTrabajoMapeos, useAnticipoAplicaciones, useInsumosPartida, useCatalogoInsumos, useCatalogoDisgregacion, useCatalogoFamiliaMapeo, useInsumoCategorias, useSunatCortes, useCotejoDecisiones, useTiposCambio, useAppConfig, resolverConfig,
  useClasificaciones, useClasificacionTerminos, useIaRecomendaciones,
  useRequisiciones, useOrdenesCompra, useOrdenesEmpresa,
  useValorizaciones,
  useCuentasBancarias, useCronogramaPagos, useMovimientosBancarios,
  useActivosPesados, useActivosFijos, useTransformaciones, useHorasMaquina,
...
const PAGE_CHUNKS = {
  ...
  'jx-captura-campo':         () => import('./components/jx-captura-campo.jsx'),
  ...
  'jx-activos-fijos':         () => import('./components/jx-activos-fijos.jsx'),
  ...
  'jx-trabajos':              () => import('./components/jx-trabajos.jsx'),
