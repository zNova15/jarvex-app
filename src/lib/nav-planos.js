...
export const GENERAL_ITEMS = new Set([
  ...
  'comparativo-periodos', 'flujo-caja', 'flujo-proyectado', 'compras-categoria', 'ordenes-intercompany',
...
const AREA = {
  contabilidad: new Set(['cont-dashboard', 'empresas', 'movimientos-contables', 'intercompany',
    ...
    'libros-electronicos', 'config-sunat', 'comparativo-periodos', 'compras-categoria', 'ordenes-intercompany']),
