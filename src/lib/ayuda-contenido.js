...
const AYUDA = {
  ...
  'ordenes-intercompany': { titulo: 'Órdenes Intercompany', que: 'Órdenes de venta/compra entre empresas del grupo.', como: [
    'Generalas para respaldar el flujo INTERCO antes de facturar.',
    'DÓNDE ESTÁ (4-sep, tanda 4): se mudó del bloque general de Contabilidad al menú del trabajo, junto a Operaciones entre Empresas — mismo motivo: se arma para una obra concreta.',
  ] },
