...
const AYUDA = {
  ...
  'evidencias': {
    ...
    rol: {
      ...
      contador: 'Ves también todo lo contable: facturas, comprobantes, bancarizaciones, guías, recibos y pagos.',
      ayudante_contador: 'Ves también todo lo contable: facturas, comprobantes, bancarizaciones, guías, recibos y pagos.',
    },
  },
  ...
  'movimientos-contables': {
    ...
    rol: {
      ayudante_contador: 'Una vez subida una bancarización queda fija: para cambiarla (constancia, tipo o montos) usá "Solicitar cambio" y lo aplica el admin o la Contadora Jefe. Antes de cada subida verás una ventana de confirmación — revisá monto y archivo ahí.',
  ...
  'sctr-personal': {
    ...
    que: 'El control de pólizas SCTR de TODO el personal gestionable (obreros, profesionales y subcontratos): vencimientos, aseguradora y constancia.',
    como: [
      'El semáforo muestra vencidos y por vencer — anticipate a la renovación.',
      'La SUBIDA de la póliza (vencimiento, aseguradora, evidencia) la hacen SOLO la Contadora Jefe y el admin.',
    ],
    rol: { prevencionista: 'Tu tarea acá es CONSULTAR los vencimientos y avisar a tiempo — la carga de pólizas la hace contabilidad.' },
  },
