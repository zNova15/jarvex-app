...
const AYUDA = {
  ...
  'guias-remision': {
    ...
    como: [
      ...
      '⏳ ESPERANDO FACTURA: si la guía referencia una factura que todavía no está cargada, la fila lo marca con "⏳ falta F001-125" y el filtro de vínculo tiene la opción "Esperando factura" para verlas juntas. No hay que hacer nada: cuando esa factura entre por Captura Mágica se vincula sola. Es un dato DERIVADO, así que el aviso desaparece solo (no queda un estado viejo dando vueltas).',
