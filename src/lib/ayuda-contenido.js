...
const AYUDA = {
  ...
  'obras': { titulo: 'Obras / Proyectos', que: 'Catálogo de obras del grupo: datos generales, quién la ejecuta, fecha de inicio, estado y avance.', como: ['La FECHA DE INICIO importa: la app la usa para advertir facturas anteriores al arranque de la obra.', 'Cerrá las obras terminadas para sacarlas de los selectores.', 'QUIÉN EJECUTA: una empresa sola, o un CONSORCIO. Si es consorcio, primero elegí la empresa del consorcio — la que tiene RUC propio, emite las facturas y lleva sus libros — y después cargá los socios con su porcentaje. Las participaciones tienen que sumar 100%.', 'Un SOCIO del consorcio no es un subcontratista: pone capital o experiencia, y no entra a planilla, EPP ni inducción. El subcontratista, que sí pone gente, se maneja en su propia sección.', 'El consorcio nace con la buena pro y se marca DISUELTO al terminar la obra. Su contabilidad queda igual: disolverlo no borra nada.'] },
  'reportes': {
    titulo: 'Reportes',
