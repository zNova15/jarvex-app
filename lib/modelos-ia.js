...
export const MODELOS_TEXTO = [
  ...
  },
  {
    ...
    detalle: 'El de pesos abiertos de OpenAI, y el más barato del catálogo con ZDR: 4 veces menos que GLM 5.3 Flash a la entrada y 3 a la salida. 24 proveedores (Groq, Cerebras, Together, Bedrock…), así que rara vez está saturado. Su punto fuerte es exactamente esta tarea: elegir una opción de una lista corta con la evidencia delante.',
    ojo: 'Contexto de 131 k — sobra para clasificar un insumo, corto para unas bases de 94 páginas.',
