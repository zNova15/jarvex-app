...
export const MODELOS_TEXTO = [
  ...
  },
  {
    ...
    detalle: 'El de pesos abiertos de OpenAI, y el más barato del catálogo con ZDR: 4 veces menos que GLM 5.3 Flash a la entrada y 3 a la salida. 24 proveedores (Groq, Cerebras, Together, Bedrock…), así que rara vez está saturado.',
    ojo: 'Piloto del 15-set contra 31 casos reales: 90% de aciertos, pero repite el bug original de Faber Castell (perforadora de oficina → herramienta manual).',
  },
  {
    ...
    ojo: 'Z.ai es china (sede en Singapur); con la política ZDR el proveedor no guarda el pedido. Piloto del 15-set: 90% de aciertos, pero un pedido tardó 217 segundos y terminó sin respuesta usable — el único de los tres con una falla de fiabilidad, no solo de acierto.',
  },
  {
    id: 'openai/gpt-5.6-luna',
    nombre: 'GPT-5.6 Luna',
    precio: { entrada: 0.20, salida: 1.20 },
    detalle: 'Contexto de 1,05 M, JSON forzado y esfuerzo de razonamiento regulable. Servido desde EE. UU. (OpenAI/Azure/Bedrock). Piloto del 15-set-2026 contra 31 casos reales (scripts/piloto-clasificacion.mjs): 97% de aciertos, 0 respuestas fuera de lista, el más rápido de los tres (3,3 s/caso) y el ÚNICO que no repitió el bug original de Faber Castell (perforadora de oficina, no herramienta). Cuesta ~5x más que GPT-OSS 120B, pero en términos absolutos clasificar el catálogo entero de una empresa (~875 descripciones) cuesta menos de medio dólar.',
