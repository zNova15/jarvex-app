...
// Por eso la cadena va de "el mejor" a "el que va a seguir estando", y termina
// fuera de OpenRouter en Claude (pago, pero nunca se retira).
...
// OJO: bajo política `zdr` los dos últimos se SALTEAN solos (no tienen endpoint
// ZDR hoy) — verificado: la cadena degrada sola, no rompe. Con `deny` entran
// los tres. Ése es el costo real de exigir ZDR: hoy queda un solo gratuito.
export const MODELO_FALLBACK_DEFAULT = 'minimax/minimax-m3:free,openrouter/free';
